 ...
 * @author David
 */
public class ClientBoardJFrame extends javax.swing.JFrame 
{
    ...
    class GameClient extends Thread{
        ...
        public void run() {
            ...
            try {
                ...
                Logger.getLogger(ClientBoardJFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//                letter = hitMarker[0]- 'A';
    ...
    public static void main(String args[]) throws IOException 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientBoardJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ClientBoardJFrame().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(ClientBoardJFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public ClientBoardJFrame() throws IOException 
    {
        rightSeaButtonArray[0][0].addActionListener(soundHandler);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Battleship Board Client");
